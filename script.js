document.addEventListener('DOMContentLoaded', function () {
    ...
    const block1Questions = [
        ...
        },
        {
            ...
            recommendation: `Уверены, что задачи вы все-таки ставите, но, возможно, делаете это не системно и с использованием нескольких информационных каналов. Необходимо определиться с каналом информирования сотрудников и помимо формулировки самой задачи, использовать еще несколько критериев, в т.ч. сроки, ответственного, результат. Подробнее см. по <a href="tasks.html" target="_blank">ссылке</a>. Использование специальных информационных продуктов позволяет не только быстро доносить новую задачу до подчиненных, но и контролировать ее исполнение.`,
        ...
        },        
        {
            id: 'meeting_protocol',
            validAnswers: ['да', 'нет'],
            recommendation: `Проведение совещания без протокола снижает эффективность данного мероприятия в несколько раз. Вести протокол совсем несложно. Для этого есть специальные шаблоны и несколько простых правил. Попробуйте заполнить протокол по <a href="meeting_protocol.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'protocol_to_task',
    ...
    const block2Questions = [
        {
            id: 'job_portrait',
            validAnswers: ['да', 'нет'],
            recommendation: `Портрет должности помогает более эффективно и оперативно осуществлять поиск сотрудников в случае открытия новых вакансий или их увольнения. Рекомендуем составить портреты ключевых должностей с использованием шаблона по <a href="employee_profile.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'instructions',
            validAnswers: ['да', 'нет'],
            recommendation: `"Лучший" способ составить должностную инструкцию - это скачать ее из Сети. Настоятельно не рекомендуем так поступать. Должностная инструкция должна быть подготовлена под конкретную должность на конкретном предприятии на конкретном этапе. Рекомендуем применять принцип "3+20" и использовать предлагаемый шаблон доступный по <a href="three_plus_twenty.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'full_efficiency',
            validAnswers: ['менее 1 месяца', 'через месяц', 'через 2 месяца', 'более трех месяцев'],
            recommendation: `Очень часто вновь нанятый сотрудник не сразу начинает приносить прибыль компании, т.е. выполнять свои должностные инструкции на 100%. Рекомендуем сократить период адаптации сотрудника до 1-2 месяцев. Один из лучших способов сокращения периода - это система наставничества, которая подразумевает составление адаптационного плана для каждого вновь приятого сотрудника. Заполните, пожалуйста, шаблоны по всем ключевым позициям по <a href="adaptation_plan.html" target="_blank">ссылке.</a>`,
            scoreMap: { 'менее 1 месяца': 1, 'через месяц': 1, 'через 2 месяца': 1, 'более трех месяцев': 0 }
        },
        {
            id: 'mentorship',
            validAnswers: ['да', 'нет'],
            recommendation: `Система наставничества - важнейший элемент адаптации нового сотрудника. Помимо адаптационного плана (см. шаблоны), она подразумевает наставника из числа опытных сотрудников. Наставник, используя адаптационный план, сопровождает новичка в течение 1-2 месяцев. Как и всякая работа, труд наставника должен быть оплачен. Рекомендуем учесть данный факт в вашем Положении об оплате труда по <a href="9.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'training',
            validAnswers: ['да', 'нет'],
            recommendation: `Система обучения сотрудников - важнейший элемент не только адаптации нового сотрудника, но и стимулирования действующих работников предприятия, а также важный инструмент повышения производительности труда. Рекомендуем составить концепцию и план обучения сотрудников, используя шаблон по <a href="10.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        }
    ];
    ...
    const block3Questions = [
        {
            id: 'payment',
            validAnswers: ['да', 'нет'],
            recommendation: `Рекомендуем составить положение об оплате труда, используя прилагаемый шаблон по <a href="11.html" target="_blank">ссылке</a>. Данный документ не только основа системы стимулирования вашего сотрудника, но и требование трудового законодательства многих стран мира, в т.ч. Российской Федерации.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'stimulation_methods',
            validAnswers: ['да', 'нет'],
            recommendation: `Оплата труда - это далеко не единственный способ стимулирования ваших сотрудников. Помимо материальных стимулов существует множество нематериальных. Сочетание материальных и нематериальных стимулов зависит от конкретного этапа развития определенной компании, а также от той или иной должности. Основа составления любой системы стимулирования - это поиск соответствия внутренних стимулов сотрудника и внешних стимулов, формируемых компанией. Рекомендуем составить проект системы стимулирования вашей компании, используя шаблон по <a href="12.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'visual_stimulation',
            validAnswers: ['да', 'нет'],
            recommendation: `Положение об оплате труди и система стимулирования, действующая на предприятии, должны быть доступны каждому сотруднику компании. Это также является важным элементом стимулирования. Рекомендуем визуализировать их в виде конкретных документов, обсудить проекты данных документов с коллективом, собрать обратную связь, при необходимости внести корректировки. Также рекомендуем разместить данные документы на корпоративном портале и проинформировать сотрудников об этом. Шаблон доступен по <a href="13.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'corporate_culture',
            validAnswers: ['да', 'нет'],
            recommendation: `Корпоративная культура компании может стать полноценным активом любого предприятия, наряду с оборудованием и даже финансовыми активами. Именно она поможет предотвратить конфликтные ситуации, сплотить и удержать коллектив в сложной ситуации, повысить мотивированность и даже производительность труда сотрудника. Рекомендуем визуализировать основные элементы вашей корпоративной культуры, используя прилагаемый шаблон по <a href="14.html" target="_blank">ссылке</a>.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        },
        {
            id: 'roles',
            validAnswers: ['да', 'нет'],
            recommendation: `Четкое представление сотрудником своих должностных обязанностей (см. рекомендации по составлению должностных обязанностей) - это важнейшая часть системы стимулирования, действующей в компании. Также эффективными элементами любой системы стимулирования могут стать понимание сотрудником бизнес-цели и задач, стоящих перед компанией в определенной временной перспективе (см. рекомендации по составлению бизнес-цели и декомпозиции ее на задачи, мероприятия и работы). Четко обрисованные и достижимые ступени карьерного роста - еще один элемент повышения мотивированности сотрудника. Рекомендуем визуализировать данные элементы с помощью нашего шаблона по <a href="15.html" target="_blank">ссылке</a> и ознакомить с ними ваших сотрудников.`,
            scoreMap: { 'да': 1, 'нет': 0 }
        }
    ];
